...
const { ObjectId, Binary } = BSON;

// type imports
/** @typedef {import('./grid_store')} GridStore */
 ...
 * @param {(_: null, gs: Chunk) => void} callback This will be called after executing
 ...
 *
 * @param {(mongoObject?: {_id?: number, files_id: number, n: number, data: import('bson').Binary}) => void} callback This will be called after executing this
